...
namespace Platinum.Tests.Integration
{
    ...
    public class UrlTaskInvokerTest
    {
        ...
        public void GetBrowsersDalReaderNoRows()
        {
            ...
            TaskInvokerException ex = Assert.Throws<TaskInvokerException>(()=>invoker.GetBrowsers(dbMock.Object).ToList());
        ...
        public void ResetBrowserRequestExceptionThrowsTaskInvokerException()
        {
            ...
            TaskInvokerException ex = Assert.Throws<TaskInvokerException>(()=>invoker.ResetBrowser(browserMock.Object,"http://192.168.0.0"));
